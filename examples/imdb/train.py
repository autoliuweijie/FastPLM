...
kernel_name = 'uer_gpt_en'
train_dataset_path = "../../datasets/imdb/train.tsv"
dev_dataset_path = "../../datasets/imdb/dev.tsv"
model_saving_path = "/apdcephfs/share_1157269/xinxzzhao/workspace/models/{}_imdb.bin".format(kernel_name)
is_load=True
