...
CUDA_VISIBLE_DEVICES='4' nohup python3 -u run_glue.py \
    --kernel $KERNEL_NAME \
    --task $TASK_NAME \
    --glue_dir $GLUE_DIR \
...
CUDA_VISIBLE_DEVICES='5' nohup python3 -u run_glue.py \
    --kernel $KERNEL_NAME \
    --task $TASK_NAME \
    --glue_dir $GLUE_DIR \
    --pooling first --seq_length 256 \
...
CUDA_VISIBLE_DEVICES='6' nohup python3 -u run_glue.py \
    --kernel $KERNEL_NAME \
    --task $TASK_NAME \
    --glue_dir $GLUE_DIR \
...
CUDA_VISIBLE_DEVICES='7' nohup python3 -u run_glue.py \
    --kernel $KERNEL_NAME \
    --task $TASK_NAME \
    --glue_dir $GLUE_DIR \
    --pooling mean --seq_length 256 \
...
export GLUE_DIR=../../../../datasets/academic/glue
export TASK_NAME=sst-2
export KERNEL_NAME=huawei_tinybert_4_en
CUDA_VISIBLE_DEVICES='4' nohup python3 -u run_glue.py \
    --kernel $KERNEL_NAME \
    --task $TASK_NAME \
    --glue_dir $GLUE_DIR \
...
export GLUE_DIR=../../../../datasets/academic/glue
export TASK_NAME=sst-2
export KERNEL_NAME=huawei_tinybert_6_en
